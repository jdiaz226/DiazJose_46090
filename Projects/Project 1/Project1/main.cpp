...
int main(int argc, char** argv){
    ...
    while(rounds<MAXRNDS){          
        ...
        for(int i=0;i<5;i++)
            if(keepers[i]!='1')
                ...
                cout<<"Last Chance... Which dice would you like to reroll?"<<endl<<endl;
                while(true){
                    cin>>keepers;
                    bool go=false;
                    for(int i=0;i<keepers.size();i++)
                ...
                for(int i=0;i<5;i++)
                    if(keepers[i]!='1')
                        ...
                        }while(catUsed[1]==true||catUsed[2]==true||catUsed[3]==true||catUsed[4]==true||catUsed[5]==true||catUsed[6]==true||catUsed[7]==true||catUsed[8]==true||catUsed[9]==true||catUsed[10]==true||catUsed[11]==true||catUsed[12]==true||catUsed[13]==true||option>13)
    }
    ...
    cout<<"Congratulations. Your total score is "<<totalScore<<endl<<"Not too shabby."<<endl;
