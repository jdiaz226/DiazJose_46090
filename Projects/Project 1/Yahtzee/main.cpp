...
int main(int argc, char** argv){
    ...
    while(rounds<MAXRNDS){          
        ...
        cout<<"Which dice would you like to reroll?"<<endl<<"1s keep dice, while 0s reroll."<<endl<<"Example: 01011 to reroll first and third."<<endl;
        while(true){
            cin>>keepers;
            bool go=false;
